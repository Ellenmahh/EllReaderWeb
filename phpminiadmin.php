...
*/
 ...
 $DBDEF=array(
 'user'=>$_SERVER['RDS_USERNAME'],#required
 'pwd'=>$_SERVER['RDS_PASSWORD'], #required
 'db'=>$_SERVER['RDS_DB_NAME'],  #optional, default DB
 'host'=>$_SERVER['RDS_HOSTNAME'],#optional
 'port'=>$_SERVER['RDS_PORT'],#optional

            ...
            <form method="post">
                ...
                <table id="tblvisualizar">
                    ...
                    <tr>
                        ...
                        <td> <img style="width:100px;" src="<?php echo $lista['capa'] ?>"></td>
                        <td> <?php echo $lista['titulo'] ?></td>
                        <td> <?php echo $lista['pdf'] ?></td>
                        <td> <?php echo $lista['genero'] ?></td>
                        <td>
                             <a href="EllReader.php?modo=editar&codigo=<?php echo $lista['id']?>#tblvisualizar">
                                 <img style="height:30px" src="icons/editar.png"></a>

                            <a href="EllReader.php?modo=excluir&codigo=<?php echo $lista['id']?>#tblvisualizar"> 
